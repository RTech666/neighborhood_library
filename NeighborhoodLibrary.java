...
public class NeighborhoodLibrary {
    ...
    public static void preloadBooks() {
        ...
        bookInventory[0] = new Book(1, "9780679734772", "The House on Mango Street", true, "John Doe");
        bookInventory[1] = new Book(2, "0307743527", "The Picture of Dorian Gray", true, "Doe John");
        bookInventory[2] = new Book(3, "9781400078776", "Never Let Me Go", false, "");
